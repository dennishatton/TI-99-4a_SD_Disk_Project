...
jp09:	brne RXCIntRtn
	...
	adiw Z,2	;Save char at end of AT#x
	ld r16,Z	; "
...
chkT:
	...
	rjmp TXLP0
chkV:
 	cpi r16,'V'	;Send all sram (variables) except buffers
	brne jp13
	ldi r17,Serbuffer-fdcRegisters ;Count between fdcRegisters & buffers
	ldi ZH,high(fdcRegisters)  ; Get sram start address
...
;Enable interrupts	
	clr r16				;Clear flags
	sts flags,r16			;
	sts SerRecvRdPtr,r16		;Init Serial pointers
	sts SerRecvWrPtr,r16
	sts SerBufCnt,r16
...
TIrdUsartData:
	lds r16,SerBufCnt
	cpi r16,0
	breq jp19		;Sent TI 0 nothing in buffer	
	dec r16
	sts SerBufCnt,r16
	
	ldi ZH,high(Serbuffer)
	ldi ZL,low(Serbuffer)
	lds r16,SerRecvRdPtr	;ptr Status byte
	inc r16			;ptr Char byte
