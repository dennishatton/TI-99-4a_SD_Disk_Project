...
Load basic program XFR. It will load XMDXFR object code.
...
It uses serveral ma.
I used a 5v wall wart with an AMS1117 3v regulator.
...
Hookup for operation
						[TTL Microprocessor]
		[ESP-01]		    -----------------------------	[3.3 power]			
           ------------------------	  NC| (VCC) No connection to VCC|	-----------		  
       /3V3| (3V3)(RX )-[DIODE+]->TX	  RX| (RXD)			|	|
      |    | (RST)(IO0) 	 | 	  TX| (TXD)			|    3V3| (3V3)
       \3V3| (EN )(IO2)	 	 |	 GND| (GND)			|    GND| (GND)
